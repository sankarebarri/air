...
| Type  | Description                                                           |
| ----- | --------------------------------------------------------------------- |
| `Any` | A pydantic FieldInfo object configured with the specified parameters. |
...
| Type              | Description                                      |
| ----------------- | ------------------------------------------------ |
| `dict[str, dict]` | Dictionary mapping field names to error details. |
...
| Type  | Description                         |
| ----- | ----------------------------------- |
| `str` | User-friendly error message string. |
